...
def generate_diagnosis():
    try:
        ...
        prompt = f'''
                  ...
                  病灶严重程度分级：
                  - 微动脉瘤（MA）：{data['ma_count']} 处，严重程度：{data['ma_severity']}
                  - 视网膜出血（HE）：{data['he_count']} 处，严重程度：{data['he_severity']}
                  - 视网膜渗出（EX）：{data['ex_count']} 处，严重程度：{data['ex_severity']}
                  - 硬性渗出（SE）：{data['se_count']} 处，严重程度：{data['se_severity']}
